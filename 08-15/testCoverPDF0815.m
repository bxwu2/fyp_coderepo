...
% Term 1
cover1 = sum(hitPDF); % sum of hit times from src to all nodes (i=/=z); vector contains sum for t hops (t entries in vector)
        ...
        combArr = nchoosek(1:n,unionIdx);                                   % union combinations
            for combIndex = 1:size(combArr,1)                               % cycle through the union combos
                ...
                for coverIdx = 1:t                                                           % for 1-100 hops
                    ...
                    transMatrixT2 = transMatrixAbs^(coverIdx);
                    transMatrixT = transMatrixT2 - transMatrixT1;
